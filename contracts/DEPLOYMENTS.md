...
| Source verification | Sourcify, `exact_match` on creation and runtime bytecode for all three (2026-09-17, `forge verify-contract --verifier sourcify --chain 5042`): [adapter](https://repo.sourcify.dev/5042/0x73c617e808ED5c7Ca41413DFC6EE940dDcBb0b8D), [escrow proxy](https://repo.sourcify.dev/5042/0x64cA39Fc57315D0D488acCaC07c37C6E841CD058), [escrow impl](https://repo.sourcify.dev/5042/0x3BD209158283FE1cd81054b1c91Ea723f1eBB251). explorer.arc.io is still behind a Circle sign-in |
...
| Arbitrator | ⏳ **handover half done.** `transferArbitrator(0x74678c07…2a54)` sent from the deployer 2026-08-29, tx `0x068ad70e0fde3bbdca4d4a67dd382e03e24a924e7160031996c0198dd15c3fea`, block `50601182`; `pendingArbitrator` now reads the Safe on two independent nodes. Until `acceptArbitrator()` is executed **from the Safe** (2 of 3, app.safe.global), `arbitrator()` is still the deployer `0x6abc2b57…849E` - a single key can rule a dispute here. Same Safe as the previous adapter: `0x74678c072Ca546f11466CD44eB7e21730a312a54`, SafeL2 1.4.1, owners `0xed733FC1…`, `0x403A027b…`, `0xC6B48f60…`. |
